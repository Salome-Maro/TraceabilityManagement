...
/**
 * This is the item provider adapter for a {@link com.rtlabs.requirements.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementItemProvider 
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_body_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_body_feature", "_UI_Requirement_type"),
				 RequirementsPackage.Literals.REQUIREMENT__BODY,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addModifiedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_modified_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_modified_feature", "_UI_Requirement_type"),
				 RequirementsPackage.Literals.REQUIREMENT__MODIFIED,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Requirement.class)) {
			...
			case RequirementsPackage.REQUIREMENT__BODY:
			case RequirementsPackage.REQUIREMENT__CREATED:
			case RequirementsPackage.REQUIREMENT__MODIFIED:
