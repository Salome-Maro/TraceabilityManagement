...
import org.amalthea4public.generic.tracecreation.TracecreationPackage;
 ...
 * @generated
 */
public class TracecreationPackageImpl extends EPackageImpl implements TracecreationPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.amalthea4public.generic.tracecreation.TracecreationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TracecreationPackageImpl() {
		super(eNS_URI, TracecreationFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TracecreationPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TracecreationPackage init() {
		if (isInited) return (TracecreationPackage)EPackage.Registry.INSTANCE.getEPackage(TracecreationPackage.eNS_URI);

		// Obtain or create and register package
		TracecreationPackageImpl theTracecreationPackage = (TracecreationPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TracecreationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TracecreationPackageImpl());
		...
		theTracecreationPackage.createPackageContents();

		// Initialize created meta-data
		theTracecreationPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTracecreationPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TracecreationPackage.eNS_URI, theTracecreationPackage);
		return theTracecreationPackage;
	}
	 ...
	 * @generated
	 */
	public TracecreationFactory getTracecreationFactory() {
		return (TracecreationFactory)getEFactoryInstance();
	}
