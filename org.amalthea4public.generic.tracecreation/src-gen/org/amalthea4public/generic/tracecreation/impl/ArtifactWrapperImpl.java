 ...
 * </p>
 * <ul>
 *   <li>{@link org.amalthea4public.generic.tracecreation.impl.ArtifactWrapperImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link org.amalthea4public.generic.tracecreation.impl.ArtifactWrapperImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.amalthea4public.generic.tracecreation.impl.ArtifactWrapperImpl#getArtifactHandler <em>Artifact Handler</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtifactWrapperImpl extends MinimalEObjectImpl.Container implements ArtifactWrapper {
	...
	protected EClass eStaticClass() {
		return TracecreationPackage.Literals.ARTIFACT_WRAPPER;
	}
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracecreationPackage.ARTIFACT_WRAPPER__URI, oldUri, uri));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracecreationPackage.ARTIFACT_WRAPPER__NAME, oldName, name));
	}
	...
	public void setArtifactHandler(String newArtifactHandler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracecreationPackage.ARTIFACT_WRAPPER__ARTIFACT_HANDLER, oldArtifactHandler, artifactHandler));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracecreationPackage.ARTIFACT_WRAPPER__URI:
				return getUri();
			case TracecreationPackage.ARTIFACT_WRAPPER__NAME:
				return getName();
			case TracecreationPackage.ARTIFACT_WRAPPER__ARTIFACT_HANDLER:
